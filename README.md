# Pump Coins — Meme Coin Trader/Detector
...
Early stage. Core discovery, risk-scoring, and monitoring services exist; this README defines the v1 feature scope going forward. See `IMPLEMENTATION_PLAN.md` and `PHASE_4_PLAN.md` for prior planning notes on wallet integration, risk scoring, and price history — still relevant as reference for later phases.
